    ...
    const handleForgotPassword = async () => {
        ...
        try {
            ...
            if (error) {
                ...
                setMessage('Kolla din e-post! Vi har skickat en länk för att återställa ditt lösenord.');
                setMode('login');
            }
        } catch {
            setError('Något gick fel. Försök igen.');
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    {mode === 'login' && (
                        <button
                            ...
                            className="text-sm text-white/50 hover:text-wine-red-light transition-colors"
                        >
                            Glömt lösenord?
                        </button>
                    )}
